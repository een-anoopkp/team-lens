...
class ProjectSnapshot(Base):
    ...
    epic_keys: Mapped[list[str]] = mapped_column(ARRAY(String), nullable=False)
    ...
    contributors: Mapped[list[str] | None] = mapped_column(ARRAY(String))
    initiative_keys: Mapped[list[str] | None] = mapped_column(ARRAY(String))
    raw_metrics: Mapped[dict] = mapped_column(JSONB, nullable=False)
